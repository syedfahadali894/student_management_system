    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="row">
            ...
            if ($result1['total']) {
                echo $result1['total'] . " ". "Students"; // Display the count of students
            } else {
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info text-white">
                <div class="card-body">
                  <h4 class="font-weight-normal mb-3">Active Status</h4>
                  <h2 class="font-weight-normal mb-5">
                  <?php
            $sql1 = "SELECT count(*) as total FROM `student` WHERE status = 'Active'";
            $query1 = mysqli_query($con, $sql1);
            $result1 = mysqli_fetch_assoc($query1);
            if ($result1['total']) {
                echo $result1['total'] . " ". "Students"; // Display the count of students
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success text-white">
                <div class="card-body">
                  <h4 class="font-weight-normal mb-3">Leave Status</h4>
                  <h2 class="font-weight-normal mb-5">

                  <?php
            $sql1 = "SELECT count(*) as total FROM `student` WHERE status = 'Deactive'";
            $query1 = mysqli_query($con, $sql1);
            $result1 = mysqli_fetch_assoc($query1);
            if ($result1['total']) {
                echo $result1['total'] . " ". "Students"; // Display the count of students
          ...
          <div class="row">
			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-3">
						<a href="student.php" class="btn btn-success"><i class="fa fa-address-card"></i> <span>Add New Student</span></a>
...
// }
    ...
    <img class="st_img" src="../images/<?php echo $row['image'];?>" alt="Image">
							...
							<td class="text-center"><?php echo $row['bcode'];?></td>
							<td class="text-center"><?php echo $row['status'];?></td>



          
					<td class="text-center"><a href="edit_student.php?id=<?php echo $row['id'];?>" ><i class="fa fa-edit text-decoration-none text-danger"></i></a>
						<a href="dlt_student.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash text-decoration-none text-success"></i></a></td>
							<td class="text-center"><a href="view_student.php?id=<?php echo $row['id'];?>"><i class="fa fa-arrows"></i></a></td> 
												</tr>
